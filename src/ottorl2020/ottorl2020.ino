...
// (leave commented out if robot is 3d printed)
#define ROBOT_3D_PRINTED 1

// klavesy pre pravy a lavy touch senzor
// (keys generated by left and right touch sensor)
#define KEY_TOUCH1 '*'
#define KEY_TOUCH2 '/'

// alebo namiesto toho prikazy
// (alternately, the touch sensors directly generate commands)
#define CMD_TOUCH1 1
#define CMD_TOUCH2 2
...
//(max length of choreography)
#define CHOREO_LEN 200

#define CAS_OTTO_SA_ZACNE_NUDIT 9000

// cisla pinov, kde su zapojene servo motory
// (servos connected to these pins: left hand, right hand, left leg, right leg, left foot, right foot)
...
// (numbering of servos, same order)
...
char check_touch()
{
  ...
  //  (if touch sensors should produce keys, use this:)
...
//  else if (digitalRead(TOUCH2)) menu_command(CMD_TOUCH2);
  ...
  // toto nechajte tak:  (leave this as is)
  else return -1;
}
...
//  (own custom serial port implementation)
...
//  (playing melodies on timer2 in the background)
